        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructors_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSessions_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendedUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WaitingListEntries_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WaitingListEntries_ClassSessions_ClassSessionId",
                        column: x => x.ClassSessionId,
                        principalTable: "ClassSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_MemberId_AttendedUtc",
                table: "AttendanceRecords",
                columns: new[] { "MemberId", "AttendedUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSessions_LocationId",
                table: "ClassSessions",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSessions_StartUtc",
                table: "ClassSessions",
                column: "StartUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_MemberId_EndUtc",
                table: "Subscriptions",
                columns: new[] { "MemberId", "EndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_WaitingListEntries_ClassSessionId_Position",
                table: "WaitingListEntries",
                columns: new[] { "ClassSessionId", "Position" });

            migrationBuilder.CreateIndex(
                name: "IX_WaitingListEntries_MemberId_ClassSessionId",
                table: "WaitingListEntries",
